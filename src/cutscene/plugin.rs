...
/// This plugin handles the cutscenes. It doesn't depend on a specific module so that cutscenes can be triggered from everywhere.
/// Works by reading the cutscene events generated by other systems and creating the corresponding cutscene.
